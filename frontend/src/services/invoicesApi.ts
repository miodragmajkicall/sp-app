...
function mapInvoiceDetail(raw: any): InvoiceDetail {
  return {
    ...
    issuer_business_name: raw.issuer_business_name ?? null,
    issuer_address: raw.issuer_address ?? null,
    issuer_tax_id: raw.issuer_tax_id ?? null,
    issuer_phone: raw.issuer_phone ?? null,
    issuer_email: raw.issuer_email ?? null,
    issuer_bank_name: raw.issuer_bank_name ?? null,
    issuer_bank_account: raw.issuer_bank_account ?? null,
    issuer_iban: raw.issuer_iban ?? null,
    issuer_swift_bic: raw.issuer_swift_bic ?? null,
